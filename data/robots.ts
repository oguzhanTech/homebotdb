...
export const robots: Robot[] = [
  {
    ...
    connectivity: "Wi-Fi, LTE (unconfirmed)",
    readinessScore: 74,
    realityScore: 68,
    ...
    imageUrl: "/images/human-form-module-figure-3-image-v3.png",
    imageUrls: [
      "/images/human-form-module-figure-3-image-v3.png",
  ...
  },
  {
    ...
    speed: "7 km/h",
    payload: "3 kg",
    sensors: "Depth camera, LiDAR option, IMU",
    processor: "Jetson Orin (variant dependent)",
  ...
  },
  {
    ...
    priceStatus: "unknown",
    batteryLife: "Unknown",
    chargeTime: "Coming soon",
    height: "173 cm",
    weight: "73 kg",
    speed: "8 km/h",
    payload: "20 kg",
    sensors: "Multi-camera, tactile (unconfirmed)",
