---
title: FIDI feeding robot resurfaces on X as Semi Robotics preps Polish home-care rollout
slug: fidi-semi-robotics-ai-feeding-robot
authorId: chuck-steward
summary: A viral clip of Semi Robotics' FIDI arm feeding a seated user is making the rounds on X, but the real story is a four-person Łódź startup with NCBR backing, care-home pilots, and a waitlist ahead of series production.
coverImage: /images/news/fidi-feeding-robot-semi-robotics.jpg
coverImageCaption: FIDI feeding robot industrial design by 2S Design for Semi Robotics. Photo courtesy of 2S Design.
...
[FIDI feeding robot demo footage](https://www.youtube.com/watch?v=4KMBHwk759s)

## From family need to care-home pilots

Semi Robotics grew from a personal need inside the founding team. After hundreds of prototype tests, the company now lists **four employees** and says video on its site shows **working prototypes**, not finished retail units. Public materials on [semirobotics.pl](https://www.semirobotics.pl/en/) state the firm is **preparing series production** and collecting **name-and-email reservations** for first deliveries.
