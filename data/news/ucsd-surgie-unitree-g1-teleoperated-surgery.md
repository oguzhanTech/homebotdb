---
title: UC San Diego teleoperated Surgie robots complete first live animal surgeries on Unitree G1
slug: ucsd-surgie-unitree-g1-teleoperated-surgery
...
**UC San Diego** engineers and surgeons used teleoperated humanoid robots nicknamed **Surgie** to finish two live gallbladder removals in a preclinical trial. The work appears in the **July 8, 2026** issue of [Nature](https://doi.org/10.1038/s41586-026-10796-x), and [UC San Diego Today](https://today.ucsd.edu/story/surgeons-use-teleoperated-humanoid-robots-to-perform-live-surgery-a-world-first) has the clearest public write-up. The robots are built on the **Unitree G1** platform: general-purpose bipeds holding standard laparoscopic tools through custom adapters, not a hospital-only surgical chassis.
...
Longer term, Yip talks about an **"autonomous surgical assistant"** that can fetch tools, tidy the room, and work beside humans, not replace the scrub team overnight. Project materials are linked from the [Humanoid Surgeon project page](https://humanoid-surgeon.github.io/).
